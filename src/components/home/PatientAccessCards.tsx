...
const services = [
  {
    ...
    description: "Multilingual guidance for accessing appointments and triage systems.",
    href: "/patient/book-appointment",
    bg: "bg-[#005EB8]",
  },
  {
    Icon: ClipboardList,
    title: "Register With Practice",
    description: "Translated registration support and onboarding guidance.",
  ...
  },
  {
    ...
    description: "Simple multilingual prescription ordering instructions.",
  ...
  },
  {
    ...
    description: "Guidance for downloading and using the NHS App.",
  ...
  },
  {
    ...
    description: "Access multilingual healthcare campaigns and public health information.",
  ...
  },
  {
    ...
    description: "Multilingual health education covering diabetes, asthma, vaccinations and more.",
  ...
  },
  {
    ...
    description: "Test results, forms, sick notes and GP admin support.",
    href: "/patient/menu",
    bg: "bg-[#8B5CF6]",
  },
  {
    ...
    description: "Important surgery updates and announcements.",
