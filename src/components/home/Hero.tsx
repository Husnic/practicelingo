...
import CyclingPhoneMock from "@/components/shared/CyclingPhoneMock";
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#005EB8] via-[#0070D8] to-[#2EB6CC] pt-16 pb-32 lg:pt-24 lg:pb-40">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1600&q=60')",
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            ...
            <div className="animate-fade-in-up delay-400 mt-10 flex flex-wrap items-center gap-5 justify-center lg:justify-start">
              ...
              {["6+ Languages", "GDPR Compliant"].map((label) => (
                <div
                  key={label}
                  className="flex items-center gap-2 text-white/80 text-sm"
                >
                  <svg
                    className="w-4 h-4 text-[#98D37F] shrink-0"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
          ...
          <div className="flex-1 flex justify-center lg:justify-end animate-scale-in delay-300">
            <div className="relative">
              ...
              <div
                className="hidden lg:block rounded-2xl overflow-hidden shadow-2xl animate-float-slow"
                style={{ zoom: 0.7 }}
              >
                <KioskDisplay practiceName="Your GP Surgery" />
              </div>

              {/* Phone — cycles through languages */}
              <div
                className="lg:absolute lg:-bottom-6 lg:-right-16 animate-float"
                style={{ animationDelay: "1s" }}
              >
                <CyclingPhoneMock practiceName="Your GP Surgery" />
              </div>
