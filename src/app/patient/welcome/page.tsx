...
const actions = [
  ...
  },
  {
    ...
    sub: "Important health information",
      ...
      <div className="p-4">
        ...
        <div className="bg-gradient-to-br from-[#005EB8] to-[#2EB6CC] rounded-3xl p-6 mb-5 text-white">
          ...
          <p className="text-blue-100 text-sm leading-relaxed">
            Welcome to Earl&apos;s Court Health &amp; Wellbeing Centre.
            PracticeLingo is here to help you in your preferred language.
          </p>
        </div>
