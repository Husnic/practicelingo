...
const topics = [
  {
    Icon: Droplets,
    title: "Diabetes",
    tags: ["Type 2", "Prevention", "Diet"],
    bg: "bg-[#EF4444]",
  },
  {
    Icon: Wind,
    title: "Asthma",
    tags: ["Inhaler", "Triggers", "Management"],
    bg: "bg-[#2EB6CC]",
  },
  {
    Icon: Heart,
    title: "Blood Pressure",
    tags: ["Heart health", "Stroke prevention"],
    bg: "bg-[#EC4899]",
  },
  {
    Icon: Brain,
    title: "Mental Health",
    tags: ["Anxiety", "Depression", "Support"],
    bg: "bg-[#8B5CF6]",
  },
  {
    Icon: User,
    title: "Women's Health",
    tags: ["Cervical screening", "Contraception"],
    bg: "bg-[#EC4899]",
  },
  {
    Icon: Syringe,
    title: "Vaccinations",
    tags: ["Flu jab", "COVID", "Children"],
    bg: "bg-[#005EB8]",
  },
  {
    Icon: Scan,
    title: "Cancer Screening",
    tags: ["Bowel", "Breast", "Cervical"],
    bg: "bg-[#EF4444]",
  },
  {
    Icon: Salad,
    title: "Healthy Eating",
    tags: ["Nutrition", "5-a-day", "BMI"],
    bg: "bg-[#98D37F]",
  },
  {
    Icon: Activity,
    title: "Exercise & Lifestyle",
    tags: ["Physical activity", "Sleep", "Stress"],
    bg: "bg-[#0B7A82]",
  },
  {
    Icon: Baby,
    title: "Children's Health",
    tags: ["Development", "Vaccinations", "Nutrition"],
    bg: "bg-[#F59E0B]",
  },
  {
    Icon: Shield,
      ...
      <div className="p-4">
        <div className="bg-[#007F3B] rounded-3xl p-5 mb-5 text-white">
          ...
          <p className="text-green-100 text-sm">
            Health A-Z — easy-to-understand health guides in your language.
          </p>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-xs text-text-secondary bg-surface px-2 py-0.5 rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
