      ...
      <div className="p-4">
        <div className="bg-[#005EB8] rounded-3xl p-5 mb-5 text-white">
          ...
          <p className="text-blue-100 text-sm">
            We&apos;ll show you the easiest way to see a GP or nurse.
          </p>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className={`text-xs font-bold px-2 py-0.5 rounded-full ${urgent ? "bg-[#EF4444]/10 text-[#EF4444]" : "bg-[#005EB8]/10 text-[#005EB8]"}`}
                    >
                      Step {step}
                    </span>
                    <p
                      className={`font-semibold text-sm ${urgent ? "text-[#EF4444]" : "text-dark"}`}
                    >
                      {title}
                    </p>
                  </div>
