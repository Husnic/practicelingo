...
const menuItems = [
  {
    ...
    sub: "See a GP, nurse or specialist",
  ...
  },
  {
    ...
    sub: "Vaccinations, screenings and more",
        ...
        <div className="mt-6 bg-surface rounded-2xl p-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-text-secondary mt-3 pt-3 border-t border-border">
              For admin requests, please speak with the receptionist or use the
              practice&apos;s online system.
            </p>
          </div>
        </div>
      </div>
