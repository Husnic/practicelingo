...
const journeySteps = [
  {
    ...
    description:
      "Patients interact with a multilingual touchscreen display positioned in the waiting room.",
    Icon: Monitor,
    bg: "bg-[#005EB8]",
  },
  {
    ...
    description:
      "Patients choose their preferred language instantly from 6 available options.",
    Icon: Globe,
    bg: "bg-[#2EB6CC]",
  },
  {
    title: "QR Continuation",
    description:
      "Patients scan a QR code to continue their journey on their own smartphone.",
    Icon: QrCode,
    bg: "bg-[#0B7A82]",
  },
  {
    ...
    description:
      "Translated information opens automatically in their phone browser, no app download needed.",
    Icon: FileText,
    bg: "bg-[#007F3B]",
  },
  {
    ...
    description:
      "Patients access all healthcare guidance without needing to rely on staff assistance.",
    Icon: CheckCircle2,
    bg: "bg-[#98D37F]",
  },
];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 space-y-6 max-w-3xl mx-auto">
              {journeySteps.map(({ title, description, Icon, bg }, i) => (
                <div
                  key={title}
                  className="flex items-start gap-6 bg-surface rounded-3xl p-6"
                >
                  <div
                    className={`w-14 h-14 ${bg} rounded-2xl flex items-center justify-center shrink-0`}
                  >
              ...
              <div className="flex-1">
                ...
                <div className="mt-8 space-y-3">
                  {[
                    ...
                    "Audio guidance in selected language",
