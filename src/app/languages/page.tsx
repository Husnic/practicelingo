...
import { languagesMetadata } from "@/lib/page-metadata";

export const metadata: Metadata = languagesMetadata;
...
const launchLanguages = [
  {
    ...
    name: "English",
    native: "English",
    sample: "Welcome to Your GP Surgery",
    code: "en",
  },
  {
    flag: "🇸🇦",
    name: "Arabic",
    native: "العربية",
    sample: "مرحبًا بكم في عيادة الطبيب",
    code: "ar",
  },
  {
    flag: "🇨🇳",
  ...
  },
  {
    ...
    name: "Portuguese",
    native: "Português",
    sample: "Bem-vindo à sua clínica médica",
    code: "pt",
  },
  {
    flag: "🇮🇳",
    name: "Hindi",
    native: "हिन्दी",
    sample: "आपके जीपी क्लिनिक में आपका स्वागत है",
    code: "hi",
  },
  {
    flag: "🇫🇷",
    name: "French",
    native: "Français",
    sample: "Bienvenue dans votre cabinet médical",
    code: "fr",
  },
];
                  ...
                  {[
                    {
                      ...
                      desc: "Selected language stays active across all QR pages",
                    },
                    {
                      Icon: Volume2,
                      bg: "bg-[#2EB6CC]",
                      title: "Audio Guidance",
                      desc: "All pages include audio playback in the selected language",
                    },
                    {
                      Icon: Type,
                      bg: "bg-[#0B7A82]",
                      title: "Accessible Text",
                      desc: "Large, clear typography designed for all reading levels",
                    },
                  ].map(({ Icon, bg, title, desc }) => (
                    <div
                      key={title}
                      className="flex items-start gap-4 bg-surface rounded-2xl p-4"
                    >
                      <div
